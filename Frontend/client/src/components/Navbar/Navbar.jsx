  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              to="/my-transports"
              className="text-gray-600 hover:text-green-600 text-sm font-medium transition-colors relative"
            >
      ...
      <div className="md:hidden border-t px-4 py-2 flex items-center justify-around">
        <Link
          to="/"
          className="text-xs text-gray-600 hover:text-green-600 font-medium py-1"
        >
          Home
        </Link>
        ...
        <Link
          to="/my-transports"
          className="text-xs text-gray-600 hover:text-green-600 font-medium py-1 relative"
        >
          {user ? "My Transports" : "Transport"}
