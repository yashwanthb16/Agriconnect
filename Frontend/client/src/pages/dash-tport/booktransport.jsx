...
import { Calendar, Clock, MapPin, Navigation, Weight, Truck, User, Phone, FileText, Users, Search, UserPlus, CheckCircle, X, Info, AlertTriangle, List, Plus, ArrowRight, CreditCard, Receipt, LayoutDashboard, Package, Shield, TruckIcon } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-2">
            <TruckIcon size={32} className="text-gray-800" />
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white border rounded-lg p-5 md:p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-xs font-medium block mb-1 text-gray-500">
                    <Truck size={12} className="inline mr-1 text-amber-600" /> Volume (m³) <span className="text-[10px]">optional</span>
                  </label>
                  <input 
                    type="number" 
                    value={volume}
